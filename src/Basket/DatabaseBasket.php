...
use App\Basket\Basket as BasketBasket;
use App\Basket\Entity\Basket;
use App\Basket\Table\BasketTable;
use App\Shop\Entity\Product;

class DatabaseBasket extends BasketBasket
{
    private $userId;
    ...
    /**
     * Permet de fusionner les paniers
     *
     * @param  BasketBasket $basket
     * @return void
     */
    public function merge(BasketBasket $basket)
    {
        $rows = $basket->getRows();
        foreach ($rows as $r) {
